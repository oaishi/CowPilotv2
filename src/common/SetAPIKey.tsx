...
const ModelDropdown = () => {
  ...
  return (
    <VStack spacing={4}>
      <Text fontSize="sm">
        You'll need an OpenAI API Key to run the CMU Web Assistant in developer mode. If you
        ...
        <br />
        <br />
        CMU Web Assistant stores your API key locally and securely, and it is only used to
